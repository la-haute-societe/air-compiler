module.exports = {
	// Java runtime directory or java command
	// If java path is not defined, you can directly target the java executable like this "C:/progra~2/Java/jre7/bin/java.exe"
	java: "java",
	...
	assets: [
		"bin///media", // Will include the folder "media" at the app root. If you remove the "///", the command will include the folder "bin/media" in the app root.
	...
	outputs: {
		...
		test : {
			...
			ios: {
				...
				// Use the new iOS compiler. Set to false to use the legacy compiler (not available anymore since v16)
				//newCompiler: false,
